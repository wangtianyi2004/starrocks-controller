...
func DecompressSRPkg() {
    ...
    tarFileName = "/root/.starrocks-controller/download/StarRocks-2.0.0-GA.tar.gz"
...
func DeployPkg() {
    ...
    // deploy fe folder
    sourceDir = "/root/.starrocks-controller/download/StarRocks-2.0.0-GA/fe"
    ...
    // deploy be folder
    sourceDir = "/root/.starrocks-controller/download/StarRocks-2.0.0-GA/be"
