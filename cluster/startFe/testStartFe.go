...
func TestStartFeCluster() {
    ...
    feStat = checkStatus.CheckFeStatus(i, user, keyRsa, sshHost, sshPort, feQueryPort)
    */
    ...
    feStat, _ = checkStatus.CheckFeStatus(i, user, keyRsa, sshHost, sshPort, feQueryPort)
